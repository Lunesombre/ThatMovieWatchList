...
if (empty($_POST) || !isset($_POST['nom']) || !isset($_POST['prenom']) || !isset($_POST['birthdate']) || !isset($_POST['email']) || !isset($_POST['pseudo']) || !isset($_POST['password'])) {
    Utils::redirect('register.php?msg=' . ConnexionMessages::ALL_FIELDS_MUST_BE_COMPLETED);
}
...
if ($testEmailUsage) {
    Utils::redirect('register.php?msg=' . ConnexionMessages::EMAIL_ALREADY_USED);
}
...
if ($testPseudoUsage) {
    Utils::redirect('register.php?msg=' . ConnexionMessages::PSEUDONYM_ALREADY_USED);
}
...
if ($insertNewUser === false) {
    Utils::redirect('register.php?msg=' . ConnexionMessages::REGISTRATION_FAILURE);
}
Utils::redirect('index.php?msg=' . ConnexionMessages::REGISTRATION_SUCCESS);
