...
if (isset($actor_id)) {
    ...
    <div class="container d-flex">
        ...
        <div class="m-5 align-items-between">
            <h2 class="text-end">
                <?php echo $actor['actor_firstname'] . ' ' . $actor['actor_name'] ?> est un/e acteur/trice.
            </h2>
...
?>
    ...
    <div class="container d-flex">
        ...
        <div class="m-5 align-items-between">
            <h2 class="text-end">
                <?php echo $director['director_firstname'] . ' ' . $director['director_name'] ?> est un/e réalisateur/trice.
            </h2>
